...
|---|---|---|---|---|
| **[AGF-BACKLOG-ENGINE](backlog/epics/AGF-BACKLOG-ENGINE.epic.json)** — JSON-first backlog engine — source of truth + tooling | active | infra | 43 / 0 / 43 | → S082 |
| **[AGF-ENGINE-OBSERVABILITY](backlog/epics/AGF-ENGINE-OBSERVABILITY.epic.json)** — Engine observability — diagnostics, logging, motion + renderer probes | active | engine | 76 / 0 / 76 |  |
...
| **[KABOOM-CREW-CHARACTERS](backlog/epics/KABOOM-CREW-CHARACTERS.epic.json)** — Kaboom Crew — procedural characters (mesh + animation + voice) | active | sample-game | 73 / 0 / 79 |  |
...
| **[KABOOM-CREW-MVP-1](backlog/epics/KABOOM-CREW-MVP-1.epic.json)** — Kaboom Crew — MVP 1 polish (audio + particles + score + title screen) | active | sample-game | 44 / 2 / 46 |  |
| **[KABOOM-CREW-MVP-2](backlog/epics/KABOOM-CREW-MVP-2.epic.json)** — Kaboom Crew — MVP 2 (mechanic depth + bot personality + power-up variety) | active | sample-game | 8 / 0 / 8 |  |
...
| **[M24](backlog/epics/M24.epic.json)** — M24 Rapier physics & colliders | active | engine | 30 / 3 / 34 |  |
...
| **[KABOOM-CREW-MVP-NETWORK](backlog/epics/KABOOM-CREW-MVP-NETWORK.epic.json)** — Kaboom Crew — networked play (connected profile, two browser tabs share one arena) | planned | sample-game | 64 / 0 / 67 |  |
...
| **[M27-DECAL-LAYER](backlog/epics/M27-DECAL-LAYER.epic.json)** — M27 Decal-on-grid renderer primitive | planned | engine | 0 / 0 / 1 | → MVP-2 |
| **[M28-REGION-RULES](backlog/epics/M28-REGION-RULES.epic.json)** — M28 Region / sector modifier primitive | planned | engine | 0 / 0 / 1 | → MVP-2 |
