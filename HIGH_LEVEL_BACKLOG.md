...
| **[AGF-ENGINE-OBSERVABILITY](backlog/epics/AGF-ENGINE-OBSERVABILITY.epic.json)** — Engine observability — diagnostics, logging, motion + renderer probes | active | engine | 58 / 0 / 58 |  |
...
| **[KABOOM-CREW-CHARACTERS](backlog/epics/KABOOM-CREW-CHARACTERS.epic.json)** — Kaboom Crew — procedural characters (mesh + animation + voice) | active | sample-game | 29 / 5 / 37 |  |
...
| **[KABOOM-CREW-MVP-2](backlog/epics/KABOOM-CREW-MVP-2.epic.json)** — Kaboom Crew — MVP 2 (mechanic depth + bot personality + power-up variety) | active | sample-game | 4 / 0 / 4 |  |
