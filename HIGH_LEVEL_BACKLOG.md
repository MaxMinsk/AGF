...
|---|---|---|---|---|
| **[AGF-BACKLOG-ENGINE](backlog/epics/AGF-BACKLOG-ENGINE.epic.json)** — JSON-first backlog engine — source of truth + tooling | active | infra | 42 / 0 / 42 | → S082 |
...
| **[KABOOM-CREW-CHARACTERS](backlog/epics/KABOOM-CREW-CHARACTERS.epic.json)** — Kaboom Crew — procedural characters (mesh + animation + voice) | active | sample-game | 69 / 0 / 75 |  |
...
| **[M24](backlog/epics/M24.epic.json)** — M24 Rapier physics & colliders | active | engine | 22 / 0 / 22 |  |
