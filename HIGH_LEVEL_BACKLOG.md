...
| **[AGF-ENGINE-OBSERVABILITY](backlog/epics/AGF-ENGINE-OBSERVABILITY.epic.json)** — Engine observability — diagnostics, logging, motion + renderer probes | active | engine | 38 / 2 / 40 |  |
...
| **[KABOOM-CREW-MVP-1](backlog/epics/KABOOM-CREW-MVP-1.epic.json)** — Kaboom Crew — MVP 1 polish (audio + particles + score + title screen) | active | sample-game | 32 / 0 / 32 |  |
...
| **[AUDIO](backlog/epics/AUDIO.epic.json)** — Audio | planned | engine | 3 / 0 / 4 |  |
...
| **[GAME-DESIGN-AGENT](backlog/epics/GAME-DESIGN-AGENT.epic.json)** — Game designer / product-owner terminal — third role in the multi-agent loop | planned | infra | 0 / 0 / 0 | → S100 |
