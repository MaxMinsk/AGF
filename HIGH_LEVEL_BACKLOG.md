...
| **[KABOOM-CREW-CHARACTERS](backlog/epics/KABOOM-CREW-CHARACTERS.epic.json)** — Kaboom Crew — procedural characters (mesh + animation + voice) | active | sample-game | 5 / 0 / 8 |  |
...
| **[EXAMPLES-FEATURE-LAB-SANDBOX](backlog/epics/EXAMPLES-FEATURE-LAB-SANDBOX.epic.json)** — examples/feature-lab/ sandbox | planned | engine | 2 / 1 / 3 |  |
