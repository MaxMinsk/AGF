...
| **[AGF-ENGINE-OBSERVABILITY](backlog/epics/AGF-ENGINE-OBSERVABILITY.epic.json)** — Engine observability — diagnostics, logging, motion + renderer probes | active | engine | 57 / 1 / 58 |  |
...
| **[KABOOM-CREW-CHARACTERS](backlog/epics/KABOOM-CREW-CHARACTERS.epic.json)** — Kaboom Crew — procedural characters (mesh + animation + voice) | active | sample-game | 2 / 3 / 8 |  |
...
| **[EXAMPLES-FEATURE-LAB-SANDBOX](backlog/epics/EXAMPLES-FEATURE-LAB-SANDBOX.epic.json)** — examples/feature-lab/ sandbox | planned | engine | 0 / 3 / 3 |  |
