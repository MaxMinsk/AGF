...
| **[KABOOM-CREW-MVP-1](backlog/epics/KABOOM-CREW-MVP-1.epic.json)** — Kaboom Crew — MVP 1 polish (audio + particles + score + title screen) | active | sample-game | 45 / 1 / 46 |  |
...
| **[M24](backlog/epics/M24.epic.json)** — M24 Rapier physics & colliders | active | engine | 32 / 1 / 34 |  |
