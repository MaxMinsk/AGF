...
- **FIX-ACCESSORY-SWAY-IN-KABOOM-001** — Re-register spring-pivot-system in kaboom-crew to restore S106 accessory sway _(pending)_
...
- **TEST-ACCESSORY-SWAY-IN-KABOOM-001** — Unit test: soft-attach-sway → spring-pivot chain rotates accessory on parent motion _(pending)_
...
- **HOUSEKEEPING-REJECT-QA-2026-05-24-001** — Archive QA-2026-05-24-001 as rejected (already fixed in main) _(pending)_
