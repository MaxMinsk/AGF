...
- **TEST-KABOOM-BOMB-COLLIDER-001** — Unit test: bomb spawn registers a Rapier body; removal releases it _(pending)_
...
- **FEAT-KABOOM-PICKUP-COLLIDER-001** — pickup-spawn-system writes static colliders on every spawned pickup _(pending)_
...
- **TEST-KABOOM-PICKUP-COLLIDER-001** — Unit test: spawned pickups carry RigidBody3D + Collider3D; collect releases _(pending)_
