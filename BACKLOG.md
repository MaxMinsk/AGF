...
- **KABOOM-RECIPE-SCHEMA** — CharacterRecipe JSON schema + TypeScript types _(pending)_
...
- **KABOOM-RECIPE-CODEC** — Recipe serialize/deserialize + seed-only resolver _(pending)_
...
- **KABOOM-RECIPE-URL-KNOBS** — Bench reads ?recipe= + ?seed= URL params _(pending)_
