...
- **KABOOM-ACCESSORY-RECIPE-FIELD** — CharacterRecipe.accessories field + codec round-trip _(pending)_
...
- **KABOOM-ACCESSORY-SPAWNER** — Bomber tree spawner adds accessory entities under their mount sockets _(pending)_
...
- **KABOOM-ACCESSORY-SOFT-ATTACH-SWAY** — Soft-attached entities sway via SpringPivot driven by parent motion _(pending)_
