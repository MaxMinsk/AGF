...
- **PROCBOMBER-PART-BUILDERS** — Per-part procedural mesh builders + multi-key registry usage _(pending)_
...
- **PROCBOMBER-LIMB-PIVOTS-COMPONENT** — LimbPivots project component carrying named pivot entity refs _(pending)_
...
- **PROCBOMBER-WALK-SWING-PIVOTS** — Bench walk-swing stub rotates shoulder/hip pivots in counter-phase _(pending)_
...
- **PROCBOMBER-LIMB-TEST-DROPDOWN** — Bench animation dropdown gains 'limb-test' option cycling each pivot _(pending)_
...
- **PROCBOMBER-PALETTE-8CH** — Palette expansion 4 → 8 channels + derived bottom-shadow tints (GDP-003) _(pending)_
