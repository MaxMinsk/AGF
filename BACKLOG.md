...
- **KABOOM-ACCESSORY-BENCH-CONTROLS** — Bench overlay gains an Accessories section — 3 multi-select dropdowns _(implemented)_
...
- **KABOOM-ACCESSORY-KABOOM-RECIPE-WIRE** — Kaboom Crew's makeKaboomRecipe seeds 0..2 accessories per bomber _(implemented)_
