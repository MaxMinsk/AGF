...
- **TEST-RAGDOLL-ACCESSORY-HIERARCHY-001** — Integration test: accessory parented to head mesh follows the ragdoll body _(implemented)_
...
- **DOC-RAGDOLL-PLAYTEST-001** — Update ragdoll-playtest.md: accessory gap closed + system list refreshed _(implemented)_
