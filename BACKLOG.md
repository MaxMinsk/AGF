...
- **KABOOM-PLAYER-VS-BOT-COLOR** — Distinct player vs bot color tint via difficulty preset patch _(pending)_
...
- **KABOOM-BOMB-COUNTDOWN-PULSE** — Bomb fuse pulses faster as it approaches 0 _(pending)_
...
- **KABOOM-MATCH-BEST-OF-5** — Match concept — first bomber to 3 wins is the match winner _(pending)_
...
- **KABOOM-CAMERA-SHAKE** — Camera shake on blast — small, decaying _(pending)_
...
- **AGF-FRAME-SPIKE-UNIT-TEST** — Unit test for AGF_FRAME_SPIKE emission + cooldown _(pending)_
...
- **AGF-DOCTOR-RECENT-COMMITS** — engine doctor — Recent commits section (last 10 git log entries) _(pending)_
...
- **AGF-ASSET-INVENTORY-TEST** — Unit test for AssetRegistry.inventory() status transitions _(pending)_
