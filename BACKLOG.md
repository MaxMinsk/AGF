...
- **PROCBOMBER-MESH-V0** — Pure humanoid mesh generator (head + torso + arms + legs) _(implemented)_
...
- **PROCBOMBER-BENCH-UI-CONTROLS** — DOM overlay: sliders + palette dropdown + reroll button _(implemented)_
