...
- **KABOOM-BOT-PERSONALITY-VARIANTS** — Bot personality variants — Hunter / Coward / Miner (GDP-005) _(implemented)_
...
- **KABOOM-REMOTE-DETONATE-PUP** — Remote-detonate power-up — fuse pauses, player triggers blast on command (GDP-006) _(implemented)_
