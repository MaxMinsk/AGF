...
- **FEAT-PERSONALITY-PALETTE-OVERRIDE-001** — Recipe palette overrides per personality _(pending)_
...
- **TEST-PERSONALITY-PALETTE-OVERRIDE-001** — Recipe builder returns the personality-mapped palette _(pending)_
...
- **FEAT-PERSONALITY-ACCESSORY-MARKER-001** — Each personality carries a distinctive accessory _(pending)_
...
- **TEST-PERSONALITY-ACCESSORY-MARKER-001** — Recipe builder writes the personality-mapped accessory _(pending)_
