...
- **KABOOM-RAGDOLL-STATE-COMPONENT** — RagdollState component + blast-direction capture on alive→dead edge _(implemented)_
...
- **KABOOM-RAGDOLL-ROOT-ARC** — Ragdoll root-arc system replaces the S100 vertical-hop tween _(implemented)_
...
- **KABOOM-RAGDOLL-LIMB-FLAIL** — Limb flail via the spring-pivot system + per-pivot initial impulse _(implemented)_
