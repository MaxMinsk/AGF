...
- **PROCBOMBER-LIMB-SEGMENT-SLIDERS** — Separate sliders for upperArm / forearm / upperLeg / lowerLeg lengths _(implemented)_
...
- **PROCBOMBER-HIP-SPREAD-SLIDER** — hipSpread recipe knob — distance between left + right legs _(implemented)_
...
- **PROCBOMBER-POSTURE-RANGES** — Widen forwardTilt + armRestAngle slider ranges + bump walk-swing amplitude _(implemented)_
...
- **PROCBOMBER-ARM-REST-APPLIES** — armRestAngle actually drives the shoulder pose at rest _(implemented)_
