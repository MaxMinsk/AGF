...
export const DIAGNOSTIC_CODES = {
  ...
  // Transform hierarchy (M16)
  AGF_TRANSFORM_PARENT_MISSING: "AGF_TRANSFORM_PARENT_MISSING",
  AGF_TRANSFORM_PARENT_SELF: "AGF_TRANSFORM_PARENT_SELF",
  AGF_TRANSFORM_PARENT_CYCLE: "AGF_TRANSFORM_PARENT_CYCLE",

  // Physics — M24-static-mesh
  AGF_RIGIDBODY3D_DYNAMIC_TRIMESH: "AGF_RIGIDBODY3D_DYNAMIC_TRIMESH",
  AGF_COLLIDER3D_TRIMESH_LARGE: "AGF_COLLIDER3D_TRIMESH_LARGE",
  AGF_COLLIDER3D_HEIGHTFIELD_DIMS: "AGF_COLLIDER3D_HEIGHTFIELD_DIMS"
} as const;
